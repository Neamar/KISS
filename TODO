...
* Update all chapters:
  00a_preface.xml                 [Roland: todo]
    - request a preface from someone else (like the DPL or a tech-ctte member)
  00b_foreword.xml                [Roland: todo]
  01_the-debian-project.xml       [Roland: todo]
    - new section “Follow Debian News” with introduction and pointers to
      ...
      media (Identi.ca, Google+, Facebook, Twitter)
  02_case-study.xml               [Roland: todo]
  03_existing-setup.xml           [Roland: todo]
    - #681399: appletalk is obsolete, no longer mention it, find what's
      used nowadays on MacOS
  04_installation.xml             [Roland: todo]
    - #675458: update recommendation between 32 and 64 bits in light of
      multiarch's availability
  05_packaging-system.xml         [Raphael: todo]
    - #675458: document multi-arch
  06_apt.xml                      [Raphael: todo]
    - #672488: do not recommend to use stable in sources.list but the
      codename (wheezy)
    - #675521: document sources.list for testing & unstable users
    - document unattended-upgrades to install security updates
    - document axi-cache to search packages
    - present a package proxy/cache: approx/apt-cacher/apt-proxy
  07_solving-problems.xml         [Roland: todo]
  ...
  12_advanced-administration.xml  [Roland: todo]
    - #673230: Document use of yum to install RPM based systems on a Debian host
    - explain that the speed of SSD disks is interesting for small database
      with complex queries requiring heavy I/O
  13_workstation.xml              [Roland: todo]
    - #674980: wine sections needs to be rewritten
  14_security.xml                 [Roland: todo]
  15_debian-packaging.xml         [Roland: todo]
